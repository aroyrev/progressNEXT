...
(function() {
        ...
        this.trigger = function(evt, operation, args) {
            ...
            if (observers.length > 0) {
                ...
                if ((arguments.length >= 2) && (typeof evt === "string") && (typeof operation === "string")) {
                    ...
                    if (arguments.length >= 1 && (typeof evt === "string")) {
                        op = undefined;
    ...
    progress.util._convertToABLWhereString = function(tableRef, filter) {
        var result = [],
            ...
            idx, length, field, type, format, operator, value, ablType, filters = (filter.filters) ? filter.filters : [filter],
            whereOperators = {
                eq: "=",
                neq: "<>",
                gt: ">",
    ...
    progress.util._convertToSQLQueryString = function(tableRef, filter, addSelect) {
        var result = [],
            logic = filter.logic || "and",
            idx, length, field, type, format, operator, value, fieldFormat, filters = (filter.filters) ? filter.filters : [filter],
...
(function() {
    ...
    progress.data.JSTableRef = function JSTableRef(jsdo, tableName) {
        ...
        this._loadBeforeImageData = function(jsonObject, beforeImageJsonIndex, keyFields) {
            var prodsBeforeData = jsonObject[this._jsdo._dataSetName]["prods:before"],
                tmpIndex = {},
                record, record2, recordId, key, tmpKeyIndex, id, jsrecord, tmpDataIndex, tmpDeletedIndex, i;
                ...
                return function(rec1, rec2) {
                    ...
                    for (var i = 0; i < sortFields.length; i++) {
                        ...
                        if (value1 > value2 || (value1 === undefined || value1 === null)) {
                            ...
                            if (value1 < value2 || (value2 === undefined && value2 === null)) {
                                return sortAscending[i] ? -1 : 1
                            }
                        }
                    }
        ...
        this._sort = function(arg1) {
            if (arguments.length === 0 && (!this.autoSort || (this._sortFn === undefined && this._sortObject.sortFields === undefined))) {
                return
            }
    ...
    progress.data.JSDO = function JSDO(resNameOrParmObj, serviceName) {
        ...
        this._syncDataSetForSubmit = function(request) {
            ...
            this._execGenericOperation(progress.data.JSDO._OP_SUBMIT, jsonObject, request, this._saveChangesComplete, this._saveChangesSuccess, this._saveChangesError);
            return promise
        };
            ...
            if (tableName) {
                if (!(jsonObject instanceof Array)) {
                    ...
                    if (data instanceof Array) {
                        ...
                        if ((addMode == progress.data.JSDO.MODE_EMPTY) && (typeof(jsonObject) == "object") && (Object.keys(jsonObject).length === 0)) {
                            jsonObject = []
                        } else {
                            if ((addMode == progress.data.JSDO.MODE_REPLACE) && (typeof(jsonObject) == "object") && (beforeImageJsonObject)) {
                                jsonObject = []
                            }
                        }
                    }
        ...
        this._updateLastErrors = function(jsdo, batch, changes) {
            if (batch) {
                ...
                for (var i = 0; i < batch.operations.length; i++) {
                    ...
                    if (!request.success && request.xhr && request.xhr.status == 500) {
                        var errors = "";
                        try {
            ...
            if (operation !== null && operation.mergeMode) {
                try {
                    ...
                    if (xhr.jsdo.isDataSet()) {
                        ...
                        if (xhr.jsdo._resource.dataProperty !== undefined) {
                            dataParameterName = xhr.jsdo._resource.dataProperty
                        } else {
                            if (xhr.jsdo._resource._tempTableName !== undefined) {
    ...
    progress.data.PluginManager.addPlugin("JFP", {
        requestMapping: function(jsdo, params, info) {
            var sortFields, field, ablFilter, sqlQuery, methodProperties, capabilities, index, capabilitiesObject, reqCapabilities = {
                    filter: {
                ...
                if (params.filter) {
                    ...
                    if (params.tableRef) {
                        if (reqCapabilities.filter.mapping === "ablFilter") {
                            ...
                            if (reqCapabilities.filter.mapping === "sqlQuery") {
        ...
        this.showListView = function() {
            ...
            if (typeof($) == "function") {
                ...
                if (this._listview.autoLink) {
                    $("#" + this._listview.name + " li").each(function() {
...
(function() {
                                ...
                                if (typeof resource.schema.properties != "undefined") {
                                    ...
                                    if (keys.length == 1) {
                                        if (typeof resource.schema.properties[keys[0]].properties != "undefined") {
                                            ...
                                            if (typeof resource.schema.properties[keys[0]].items != "undefined") {
                                    ...
                                    if (keys.length == 1) {
                                        ...
                                        if (typeof resource.schema[keys[0]].items != "undefined") {
                                            ...
                                            if (typeof resource.schema[keys[0]].properties != "undefined") {
                                                resource._dataSetName = keys[0];
                                                ...
                                                case "RESPONSE_BODY,REQUEST_BODY":
                                                    if (xhr && !reqBody) {
                                                        ...
                                                        if (isInvoke && (fn.definition.params[i].xType && ("DATASET,TABLE".indexOf(fn.definition.params[i].xType) != -1))) {
                                                            ...
                                                            if (unwrapped) {
                                                                if ((typeof(reqParam) == "object") && (Object.keys(reqParam).length == 1) && (typeof(reqParam[name]) == "object")) {
                                                                    reqParam = reqParam[name]
                                                                }
                                                            } else {
                                                                if ((typeof(reqParam) == "object") && (typeof(reqParam[name]) == "undefined")) {
                                                                    reqParam = {};
    ...
    progress.data.Session = function Session() {
        ...
        this.login = function(serviceURI, loginUserName, loginPassword, loginTarget) {
                ...
                if (arguments[0] && typeof(arguments[0]) === "object") {
                    if (arguments[0].serviceURI) {
                        ...
                        if (typeof iOSBasicAuthTimeout === "undefined") {
                            ...
                            if (iOSBasicAuthTimeout && (typeof iOSBasicAuthTimeout != "number")) {
            ...
            xhr.pdsession = this;
            try {
                this._setXHRCredentials(xhr, "GET", this.serviceURI + this.loginTarget, uname, pw, isAsync);
        ...
        this.addCatalog = function() {
            var catalogURI, catalogUserName, catalogPassword, isAsync = false,
                xhr, deferred, jsdosession, iOSBasicAuthTimeout, catalogIndex;
            if (arguments.length > 0) {
                if (typeof(arguments[0]) === "object") {
        ...
        function setRequestHeaderFromContextProps(session, xhr) {
            if (session.xClientProps) {
                ...
                if (session._contextProperties.contextHeader !== undefined) {
    ...
    progress.data.Session.prototype._eventNames = ["offline", "online", "afterLogin", "afterAddCatalog", "afterLogout"];
    ...
    progress.data.JSDOSession = function JSDOSession(options) {
            ...
            if (xhr && xhr._deferred) {
                ...
                if (deferred._numCatalogsProcessed === deferred._numCatalogs) {
                    ...
                    if (!deferred._overallCatalogResult) {
                        xhr._deferred.resolve(xhr._jsdosession, progress.data.Session.SUCCESS, xhr._deferred._results)
                    } else {
                        xhr._deferred.reject(xhr._jsdosession, progress.data.Session.GENERAL_FAILURE, xhr._deferred._results)
                    }
                }
            }
        }
        ...
        function onAfterLogout(pdsession, errorObject, xhr) {
            if (xhr && xhr._deferred) {
                if (!errorObject && !pdsession.loginResult) {
                    xhr._deferred.resolve(xhr._jsdosession, progress.data.Session.SUCCESS, {
                        errorObject: errorObject,
                        xhr: xhr
                    })
                } else {
                    xhr._deferred.reject(xhr._jsdosession, progress.data.Session.SUCCESS, {
                        errorObject: errorObject,
                        xhr: xhr
                    })
                }
        ...
        this.addCatalog = function(catalogURI, username, password, options) {
            var deferred = $.Deferred(),
                catalogURIs, numCatalogs, catalogIndex, addResult, errorObject, iOSBasicAuthTimeout;
            if (typeof catalogURI == "string") {
                ...
                if (catalogURI instanceof Array) {
                    ...
                    throw new Error(progress.data._getMsgText("jsdoMSG033", "JSDOSession", "addCatalog", "The catalogURI parameter must be a string or an array of strings."))
                }
            }
            if (typeof(options) === "object") {
                iOSBasicAuthTimeout = options.iOSBasicAuthTimeout
...
(function() {
    ...
    function initializeJSDO(transport, options) {
        ...
        if (transport.tableRef === undefined) {
            ...
            if (jsdo[transport.tableRef] === undefined) {
    ...
    JSDOTransport = kendo.data.RemoteTransport.extend({
        init: function(options) {
            ...
            if (transport.countFnName !== undefined && typeof(transport.jsdo[transport.countFnName]) !== "function") {
                throw new Error("Invoke operation '" + transport.countFnName + "' for countFnName is not defined.")
            }
        ...
        _initConvertTypes: function() {
            var transport = this,
                i, schema, fieldName, array = [];
            transport._convertTypes = false;
            schema = transport.jsdo[transport.tableRef].getSchema();
            for (i = 0; i < schema.length; i += 1) {
                fieldName = schema[i].name;
                if (fieldName.length > 0 && fieldName.charAt(0) !== "_") {
                    if (schema[i].type === "string" && schema[i].format && (schema[i].format.indexOf("date") !== -1)) {
            ...
            if (array.length > 0) {
                ...
                transport._convertFields._dateTimePattern = new RegExp("^([0-9]+)?-([0-9]{2})?-([0-9]{2})?T([0-9]{2})?:([0-9]{2})?:([0-9]{2})?.([0-9]{3})?$")
            }
        },
        _convertDataTypes: function(data) {
            var transport = this,
                k, fieldName, array, ablType;
            ...
            for (k = 0; k < transport._convertFields._dateFields.length; k += 1) {
                ...
                if (typeof(data[fieldName]) === "string") {
                    ...
                    if (array.length > 0) {
                        data[fieldName] = new Date(parseInt(array[1], 10), parseInt(array[2], 10) - 1, parseInt(array[3], 10))
                    } else {
                        ...
                        if (ablType === "DATETIME") {
                            ...
                            if (array.length > 0) {
                                data[fieldName] = new Date(parseInt(array[1], 10), parseInt(array[2], 10) - 1, parseInt(array[3], 10), parseInt(array[4], 10), parseInt(array[5], 10), parseInt(array[6], 10), parseInt(array[7], 10))
                            }
                        } else {
            ...
            for (i = 0; i < schema.length; i += 1) {
                if (schema[i].name.length > 0 && schema[i].name.charAt(0) !== "_") {
                    ...
                    if (type === "integer") {
                        ...
                        if (type === "string" && schema[i].format && schema[i].format.indexOf("date") !== -1) {
                            type = "date"
                        }
                    }
        ...
        read: function(options) {
            try {
                var jsdo = this.jsdo,
                    filter, data = {},
                    transport = this,
                    callback, property, optionsMapping = {
                        filter: "filter",
                        take: "top",
                        skip: "skip",
                        sort: "sort"
                    ...
                    if (options.data) {
                        for (property in options.data) {
                            if (options.data.hasOwnProperty(property)) {
                                if (options.data[property] !== undefined && optionsMapping[property]) {
                                    if (filter === undefined) {
                                        filter = {}
                                    }
                ...
                callback = function onAfterFillJSDO(jsdo, success, request) {
                    if (success) {
                        ...
                        if (options.data && options.data.take) {
                            if (!transport.readLocal && transport.countFnName !== undefined && typeof(jsdo[transport.countFnName]) === "function") {
                                promise = jsdo.invoke(transport.countFnName, {
                                    filter: request.objParam.filter
                                });
                                promise.done(function(jsdo, success, request) {
                                    var exception, total;
                                    try {
                                        if (typeof(request.response) === "object" && Object.keys(request.response).length === 1) {
                                    ...
                                    if (total !== undefined) {
                                        ...
                                        exception = new Error("Unexpected response from '" + transport.countFnName + "' operation.");
                                        options.error(request.xhr, request.xhr.status, exception)
                                    }
                                });
                                promise.fail(function(jsdo, success, request) {
                                    var exception;
                                    exception = new Error("Error invoking '" + transport.countFnName + "' operation.");
                                    options.error(request.xhr, request.xhr.status, exception)
                                })
                            } else {
                                options.success(data)
            ...
            if (options.batch) {
                ...
                if (options.data.created instanceof Array) {
                    for (i = 0; i < options.data.created.length; i += 1) {
                        jsrecord = jsdo[transport.tableRef].findById(options.data.created[i]._id);
                        if (jsrecord) {
                            transport._convertDataTypes(jsrecord.data);
                            array.push(jsrecord.data)
                        } else {
                            if (jsdo.autoApplyChanges) {
                                options.error(null, null, new Error("Created record was not found in memory."));
                                return
                            }
                        }
                    }
                ...
                if (options.data.updated instanceof Array) {
                    for (i = 0; i < options.data.updated.length; i += 1) {
                        jsrecord = jsdo[transport.tableRef].findById(options.data.updated[i]._id);
                        if (jsrecord) {
                            transport._convertDataTypes(jsrecord.data);
                            array.push(jsrecord.data)
                        } else {
                            if (jsdo.autoApplyChanges) {
                                options.error(null, null, new Error("Updated record not found in memory."));
                                return
                            }
                        }
                    }
                ...
                if (options.data.destroyed instanceof Array) {
                    for (i = 0; i < options.data.destroyed.length; i += 1) {
                        jsrecord = jsdo[transport.tableRef].findById(options.data.destroyed[i]._id);
                        if (jsrecord && jsdo.autoApplyChanges) {
                            options.error(null, null, new Error("Deleted record was found in memory."));
                            return
                        }
                    }
                }
                ...
                if (jsdo._resource.idProperty) {
                    if (request && request.batch && request.batch.operations instanceof Array && request.batch.operations.length === 1) {
        ...
        _saveChanges: function(options) {
            var transport = this,
                callback = function onAfterSaveChanges(jsdo, success, request) {
                    var jsrecord, xhr, status, exception;
                    if (success) {
        ...
        create: function(options) {
            var jsdo = this.jsdo,
                jsrecord, saveUseRelationships = jsdo.useRelationships;
            options.batch = options.data.models instanceof Array;
            try {
                jsdo.useRelationships = false;
                if (options.batch) {
                    options.error(null, null, new Error("A newer version of Kendo UI is expected for batching support."))
                } else {
        ...
        submit: function(options) {
            var jsdo = this.jsdo,
                i, jsrecord, saveUseRelationships = jsdo.useRelationships;
