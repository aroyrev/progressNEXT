...
(function() {
    var provider = app.data.progressNext = new Everlive({
            offlineStorage: true,
            apiKey: '6kMvocCCx4wOAGtY',
            masterKey: 'vefPLZ1apnZfAcigp0KlJmOY73dVKYjx',
...
// START_CUSTOM_CODE_progressNext
// END_CUSTOM_CODE_progressNext
