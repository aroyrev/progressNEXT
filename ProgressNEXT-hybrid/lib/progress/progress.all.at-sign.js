/*
Progress JSDO Version: 4.2.0  workaround for at-sign in user name on Android
...
(function () {
    ...
    progress.data.Session = function Session() {
        ...
        var myself = this,
            ...
            isAndroid422 = false,  // workaround for at-sign in user name on Android
        ...
        if (typeof navigator  !== "undefined") {
            if (typeof navigator.userAgent !== "undefined") {
                ...
                isAndroid422 = navigator.userAgent.toLowerCase().indexOf('android 4.2.2') > -1; // workaround for at-sign in user name on Android
            }
        }
        ...
        this._setXHRCredentials = function (xhr, verb, uri, userName, password, async) {
            ...
            if (userName
                ...
                else if (isAndroid422 && (userName.indexOf('@') > -1) ) {  // workaround for at-sign in user name on Android
                    xhr.open(verb, uri, async);                    
                }
                else {
